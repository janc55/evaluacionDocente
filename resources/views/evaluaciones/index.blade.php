        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <x-table>
                <x-slot name="header">
                    ...
                    <x-table-column>Carrera</x-table-column>
                ...
                @foreach($designacionMaterias as $designacion)
                    <tr>
                        ...
                        <x-table-column>{{$designacion->materia->carrera->carrera_sigla}}</x-table-column>
                        ...
                        <x-table-column>
                            <x-button-link href="#">Ver evaluación</x-button-link>
                        </x-table-column>                        
                    </tr>
                @endforeach
            </x-table>
