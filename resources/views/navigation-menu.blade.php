    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('gestiones.index') }}" :active="request()->routeIs('gestiones.index')">
                        {{ __('Gestión') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('designacion-materias.index') }}" :active="request()->routeIs('designacion-materias.index')">
                        {{ __('Materias') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('evaluaciones.index') }}" :active="request()->routeIs('evaluaciones.index')">
                        {{ __('Evaluacion Docente') }}
                    </x-nav-link>
                </div>
            </div>
